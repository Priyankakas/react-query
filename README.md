# react-query
This is basic React Query Application which demonstatrates basic use of react query in application. JSON Server is used to serve web page
...
5.Run react app on terminal localhost:3000 and json server on localhost:4000
